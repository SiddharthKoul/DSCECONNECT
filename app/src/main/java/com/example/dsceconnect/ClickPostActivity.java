...
public class ClickPostActivity extends AppCompatActivity {
    ...
    private String PostKey,databaseUserID;

    private DatabaseReference ClickPostRef;
    private String EncKey,EncID,description,image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EncKey=getIntent().getExtras().get("key_encKey").toString();
        EncID=getIntent().getExtras().get("key_encID").toString();
        ...
        ClickPostRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot)
            {
                if(snapshot.exists())
                {
                    ...
                    if(EncID.equals(databaseUserID))
                    {
